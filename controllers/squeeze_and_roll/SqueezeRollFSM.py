...
from .states.squeeze import *
from .states.roll import *
from .states.release import *

# define reflex FSM class
class SqueezeRollFSM(FiniteStateMachine):
    def __init__(self, states=[]):
        states = [Waiting(),
                Squeeze(),
                Roll(),
                Release()] # Note: FSM will start in first state in states list above
